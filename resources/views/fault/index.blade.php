...
@section('content')
<div class="card">
	<div class="card-header"><h1 class="card-title">Fault Report</h1></div>
	<div class="card-body">
		...
		<ul class="nav nav-tabs">
			<li class="nav-item">
				<a class="nav-link" href="{{ route('building.index') }}">Building</a>
			</li>
		</ul>

		@include('fault._index')
...
$("#orderitem1,#orderitem2").DataTable({
	...
	"order": [[0, "desc" ]],	// sorting the 1st column ascending
	// responsive: true
});
