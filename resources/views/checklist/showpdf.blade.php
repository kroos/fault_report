...
class PDF extends PDF_MC_Table
{
	...
	{
		// Logo
		$this->Image('images/maintenance.JPG', NULL, NULL, 181);
	...
	function Footer()
	{
		...
		$this->Cell(0, 4, 'PRPC UF Telecom', 0, 1, 'C');
		// Arial italic 5
...
$pdf->SetTitle('PPM Inspection Checklist '.$inspection->id);
...
$filename = 'PPM Inspection Checklist'.$inspection->id.'.pdf';
