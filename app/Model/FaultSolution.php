...
class FaultSolution extends Model
{

	protected $connection = 'mysql';
	protected $table = 'faults_solutions';


/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// hasmany
	public function hasmanysolutionimage()
	{
		return $this->hasMany('App\Model\FaultSolutionImage', 'fault_solution_id');
	}
