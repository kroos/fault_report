...
class FaultFinding extends Model
{

	protected $connection = 'mysql';
	protected $table = 'faults_findings';


/////////////////////////////////////////////////////////////////////////////////////////////////////////////
// hasmany
	public function hasmanyfindingimage()
	{
		return $this->hasMany('App\Model\FaultFindingImage', 'fault_finding_id');
	}
